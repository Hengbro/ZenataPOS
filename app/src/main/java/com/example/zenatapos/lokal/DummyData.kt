package com.example.zenatapos.lokal
...
object DummyData {
    ...
    /*val listCategory = listOf(
        Category(id = 1, name = "Elektronik", imageDummy = R.drawable.warung),
        Category(id = 2, name = "Handphone", imageDummy = R.drawable.tempat_makan),
        Category(id = 3, name = "Keuangan", imageDummy = R.drawable.kosan),
        Category(id = 4, name = "Komputer", imageDummy = R.drawable.penginapan),
        Category(id = 5, name = "Perawatan Hewan", imageDummy = R.drawable.hotel),
    )*/
